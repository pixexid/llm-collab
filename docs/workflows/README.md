...
2. `claude-code-desktop-computer-use-bridge.md` — parked/dormant; BB workers
   should use `bb-workers.md`; formerly the agent-to-agent comms reference
   (Codex-only Computer-Use doorbell + bidirectional `llm-collab` mailbox)
