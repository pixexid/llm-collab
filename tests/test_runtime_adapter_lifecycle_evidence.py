        ...
        def auto_clear_fold(record_id, rows):
            ...
            if current.opened and not current.release_event_seen:
                return current.__class__(
                    ...
                    unresolved_attempt_tuples=current.unresolved_attempt_tuples,
                    reconciled_attempt_tuples=current.reconciled_attempt_tuples,
                    fresh_handshake=current.fresh_handshake,
                    valid_health_count=current.valid_health_count,
                    health_failure_count=current.health_failure_count,
                    release_reviewed=current.release_reviewed,
