...
## Setup
- Run the deployed runtime; source checkouts are for lane work only.
- Know your agent id.
...
3. Run `~/.local/share/llm-collab/runtime/main/bin/llm-collab current_runtime.py --agent <agent_id>`.
