...
def main(*, input_fn: Callable[[str], str] | None = None):
    ...
    print("   # Wait beyond pm2-logrotate's default 30-second worker interval.")
    print("   sleep 35")
    print("   pm2 trigger pm2-logrotate 'list watched logs'")
    print("   # PASS only if the returned map includes Logs/watchers/ and ~/.pm2/logs/ paths.")
    print("   # If either path class is missing, stop; see docs/adapters/pm2.md.")
    print()
